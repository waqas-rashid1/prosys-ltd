              ...
              <div className="max-w-[1400px] mx-auto px-6 lg:px-12 pb-12 lg:pb-16">
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-5">
                    <span className="px-3 py-1 text-[11px] font-semibold bg-accent text-white uppercase tracking-wider">
                      {post.category}
                    </span>
                  ...
                  <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-[1.12]">
                    {post.title}
                  </h1>
                </motion.div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                ...
                >
                  ...
                  <div className="pt-4 border-t border-card-light-border">
                    ...
                    <div className="flex gap-2">
                      <button className="w-8 h-8 border border-card-light-border flex items-center justify-center text-text-dark-muted hover:text-accent hover:border-accent transition-all cursor-pointer" aria-label="Share">
                        <Share2 size={14} />
                      </button>
                      <button className="w-8 h-8 border border-card-light-border flex items-center justify-center text-text-dark-muted hover:text-accent hover:border-accent transition-all cursor-pointer" aria-label="Bookmark">
                        <BookOpen size={14} />
                      </button>
                    </div>
                  </div>
              ...
              <div className="lg:col-span-8 py-12 lg:py-16 lg:px-12 border-x border-card-light-border">
                ...
                <motion.p
                  ...
                  className="text-xl md:text-2xl text-text-dark font-light leading-relaxed mb-10 pb-10 border-b border-card-light-border"
                >
                  {post.excerpt}
                </motion.p>

                {/* Body paragraphs with staggered animation */}
                <article>
                  {post.content.map((paragraph, i) => (
                    <motion.p
                      ...
                      className="text-text-dark text-[17px] leading-[1.85] mb-7 last:mb-0"
                    >
                      {paragraph}
                    </motion.p>
                  ))}
                ...
                <motion.div
                  ...
                  className="mt-14 pt-8 border-t border-card-light-border"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-bold text-text-dark">PROSYS LTD Team</p>
                      <p className="text-xs text-text-dark-muted">Engineering & Strategy</p>
                    </div>
                  </div>
                </motion.div>
              </div>
                  ...
                  <div className="space-y-4">
                    {relatedPosts.map((r) => (
                      <Link key={r.slug} href={`/blog/${r.slug}`} className="block group">
                        <p className="text-xs font-bold text-text-dark group-hover:text-accent transition-colors leading-snug mb-0.5">
                          {r.title}
                        </p>
